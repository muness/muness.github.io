...
Disequilibrium isn’t chaos; it’s a coordination tool. Create enough shared tension that the old equilibrium is intolerable, and the system can move together. For the full mapping from the Semmelweis case to org practice, see [Appendix D — Coordination Trap Case](#coordination-trap-case).
...
- **Postrel, Virginia** — *The Future and Its Enemies: The Growing Conflict Over Creativity, Enterprise, and Progress* (Free Press, 1998). Introduces the “dynamist vs. stasist” distinction; supports organizational application of bottom-up discovery and feedback-driven progress.
