...
Some companies are beginning to recognize that automation changes where expertise is needed rather than making it disappear. Ford is one example. It had relied more heavily on automated quality systems without getting the results it wanted. Its response was to move veteran engineers upstream: they now review designs before they reach factories, teach younger engineers, and help improve the automated tools. The new division of labor is explicit. Automation scans, tests, and flags at scale; veteran engineers decide which failures to look for, judge what matters, and turn what they learn into better designs and tools. Ford did not simply add people back. It changed the pairing: automation provides scale; veteran engineers provide the failure knowledge, judgment, and feedback that make that scale useful.[^ford]

Salesforce reports a different approach in customer support. It says its AI support agent handled 2.6 million conversations and resolved 63 percent of customer questions with satisfaction scores similar to human agents. Its support organization shrank through attrition and redeployment, while hundreds of support engineers moved into growing parts of the company.[^salesforce]
...
[^ford]: Keith Naughton, [“Ford’s AI Hiccups Lead Carmaker to Rehire ‘Gray Beard’ Engineers”](https://news.bloomberglaw.com/tech-and-telecom-law/ford-ai-hiccups-push-carmaker-to-rehire-gray-beard-inspectors), *Bloomberg News*, June 25, 2026, reports Ford's disappointing results from automated quality systems and its use of veteran engineers to train younger staff and improve the tools. Ford's [company account of its quality overhaul](https://www.fromtheroad.ford.com/us/en/articles/2026/ford-tops-jd-power-initial-quality-study) describes roughly 300 veteran engineers running weekly design reviews, alongside AI vision systems and automated software testing. Ford changed several parts of its quality system; this example identifies the complement shift rather than crediting one intervention for the result.
