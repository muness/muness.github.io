...
- The `strategy-report.md` chart comparing evidence as decoration versus evidence as trigger is carried into the essay set, not left in source notes.
...
- The `strategy-report.md` chart is omitted, leaving the Toyota/evidence-trigger contrast implicit.
