...
The companion posts cover [computer use with Cua Driver, Jev, and Qwen](/posts/computer-use-cua-jev-qwen/), [one Qwen 27B for chat and SystemOne](/posts/qwen-27b-chat-and-systemone/), and [running Codex on a remote host over SSH, Tailscale, and Coder](/posts/codex-over-ssh-tailscale-coder/).
